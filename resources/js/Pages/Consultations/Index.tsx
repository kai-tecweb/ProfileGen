...
export default function Index({ consultations: initialConsultations }: ConsultationsIndexProps) {
    ...
    useEffect(() => {
        ...
        const existingConsultation = (page.props as any).existing_consultation;
        if (existingConsultation) {
            const exists = consultations.some(c => c.id === existingConsultation.id);
            if (!exists) {
                setConsultations([existingConsultation, ...consultations]);
            }
        }
    }, [initialConsultations, page.props]);
